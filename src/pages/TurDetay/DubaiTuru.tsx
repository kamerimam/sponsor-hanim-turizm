...
import dubaiImg from "@/assets/images/hero-bg.png";
...
const INFO_ITEMS = [
  ...
  { icon: Plane, label: "Kalkış", value: "İstanbul" },
  { icon: Hotel, label: "Konaklama", value: "4★ – 5★ Oteller" },
  { icon: Users, label: "Rehberlik", value: "Türkçe Profesyonel" },
  { icon: DollarSign, label: "Fiyat", value: "1.100$ / kişi'den başlayan" },
];
...
const DAILY_PROGRAM = [
  {
    ...
    highlight: false,
    description:
      "İstanbul'dan direkt uçuşla Dubai'ye varış. Havalimanında özel aracımızla karşılama ve 5 yıldızlı otelinize transfer. Akşam yürüyüşü için Jumeirah Beach'e inebilir, çölün sıcağından denizin serinliğine geçişi hissedebilirsiniz.",
  },
  {
    day: 2,
    ...
    highlight: true,
    description:
      "Sabah dünyanın en yüksek binası Burj Khalifa'nın 124. katından Dubai manzarası. Ardından Dubai Mall'da alışveriş ve Dubai Fountain gösterisi. Akşam geleneksel abra teknesiyle Dubai Creek turu.",
  },
  {
    day: 3,
    title: "Çöl Safarisi & Bedevi Gecesi",
    icon: Sun,
    highlight: true,
    description:
      "Öğleden sonra 4x4 araçlarla kızıl kum tepelerinde dune bashing. Deve turu, gün batımında çölün sessizliği ve geleneksel Bedevi kampında nargile, henna, açık büfe akşam yemeği ve tanoura dansı gösterisi.",
  },
  {
    day: 4,
    title: "Abu Dhabi Turu",
    icon: Star,
    highlight: false,
    description:
      "Tam günlük Abu Dhabi gezisi: Şeyh Zayed Camii'nin beyaz mermerlerinde saatlerce kaybolun, Emirates Palace Otel'i görün, Etihad Towers'a çıkın. Ferrari World veya Yas Island ekstra seçenekler.",
  },
  {
    day: 5,
    ...
    highlight: false,
    description:
      "Dubai Marina'da yat turu, Palm Jumeirah'da Atlantis The Palm'ı ziyaret, The View at The Palm seyir terası. Akşam Marina Walk'ta serbest zaman.",
  },
  {
    day: 6,
    title: "Eski Dubai & Altın Çarşısı",
    icon: ShoppingBag,
    highlight: false,
    description:
      "Bastakiya'nın tarihi dar sokakları, Dubai Müzesi, Altın Çarşısı ve Baharat Çarşısı. Öğleden sonra serbest zaman: otel havuzu, plaj ya da Miracle Garden.",
  },
  {
    day: 7,
    title: "Dönüş",
    ...
    highlight: false,
    description:
      "Kahvaltının ardından havalimanına transfer ve İstanbul'a dönüş. Çölde başlayıp gökdelenlerde biten bir hafta geride kalıyor.",
  },
];
...
const INCLUDED = [
  ...
  "6 gece 4★–5★ otel konaklaması",
  "Günlük açık büfe kahvaltı",
  "Çöl safarisi ve Bedevi gecesi akşam yemeği",
  "Abu Dhabi tam günlük tur",
  "Dubai şehir turu ve Burj Khalifa 124. kat bileti",
];

const NOT_INCLUDED = [
  "Yurtdışı çıkış harcı",
  "BAE vizesi (tarafımızca alınır — bilgi için iletişime geçin)",
  "Öğle ve akşam yemekleri (belirtilenler hariç)",
  "Kişisel harcamalar ve alışveriş",
  "Ekstra turlar (Ferrari World, Yas Island vb.)",
  "Minibar",
];

export default function DubaiTuru() {
  ...
  useSeo({
    title: "Ankara Dubai Turu 2026 | 7 Gün 1.100 USD — Burj Khalifa, Safari",
    description: "Ankara'dan kalkışlı 7 günlük Dubai turu. Burj Khalifa, Dubai Mall, çöl safarisi, Abu Dhabi Şeyh Zayed Camii, Palm Jumeirah. Kişi başı 1.100 USD'den başlayan fiyatlarla.",
    path: "/turlar/dubai-turu",
    image: "https://sponsorhanimtravel.com/og-dubai.jpg",
    keywords: "ankara dubai turu, dubai turu 2026, dubai tur fiyatları, burj khalifa gezi, abu dhabi turu, çöl safarisi dubai, palm jumeirah, ankara seyahat acentası dubai",
    jsonLd: buildTourJsonLd({
      name: "Dubai Turu",
      description: "7 günlük Dubai turu: Burj Khalifa, Dubai Mall, çöl safarisi, Abu Dhabi ve Palm Jumeirah.",
      image: "https://sponsorhanimtravel.com/og-dubai.jpg",
      slug: "dubai-turu",
      price: 1100,
      currency: "USD",
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src={dubaiImg}
            alt="Dubai Turu — Burj Khalifa ve çöl"
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            <Badge className="bg-primary/90 text-primary-foreground text-sm px-4 py-1 mb-6">
              Dubai Turu — 7 Gün 6 Gece
            </Badge>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-6 leading-tight">
              Çölün Modern Yüzü{" "}
              <br className="hidden md:block" />
              <span className="text-primary italic">Dubai</span>
            </h1>
            <p className="text-base md:text-lg text-white/80 max-w-2xl mx-auto mb-10 font-light">
              Dünyanın en yüksek binasından kızıl çöl tepelerine, lüks marinalardan tarihi çarşılara — tek bir turda Dubai'nin tüm yüzleri.
            </p>
      ...
      <section className="py-24 relative overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img src={dubaiImg} alt="Dubai" className="w-full h-full object-cover object-center opacity-40" />
          <div className="absolute inset-0 bg-primary/90 mix-blend-multiply" />
        </div>
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">
            Dubai'yi Keşfetmeye Hazır mısınız?
          </h2>
          <p className="text-white/90 text-lg mb-10 max-w-2xl mx-auto">
            Lüks, macera ve kültür — hepsi bir arada. Kontenjanlar sınırlı, yerinizi şimdi ayırın.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
